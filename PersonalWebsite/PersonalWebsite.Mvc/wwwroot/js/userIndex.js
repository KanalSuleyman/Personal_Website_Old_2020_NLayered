        ...
        placeHolderDiv.on('click', '#btnSave', function (event) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    const newFormBody = $('.card', userAddAjaxModel.UserAddPartial);
                    ...
                    if (isValid) {
                        ...
                        table.rows.add([
                            [
                                ...
                                `<img src="~/userImages/${userAddAjaxModel.UserDto.User.PictureFileName}" alt="${userAddAjaxModel.UserDto.User.UserName}" style="max-height: 50px; max-width: 50px;"/>`,
                                `
                                <div class="column-operations">
                                    <button class="btn-update" data-id="${userAddAjaxModel.UserDto.User.Id}"><i class='bx bx-edit-alt'></i></button>
                                    <button class="btn-delete" data-id="${userAddAjaxModel.UserDto.User.Id}"><i class='bx bxs-trash'></i></button>
                                </div>
                                `
                        ...
                        table.draw();
                        toastr.success(`${userAddAjaxModel.UserDto.Message}`, "Successfully Added!");
                    } else {
                        let summeryText = "";
